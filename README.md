...
[![Windows](https://github.com/spur27/renweb-example-plugin/actions/workflows/windows_make_test.yml/badge.svg)](https://github.com/spur27/renweb-example-plugin/actions/workflows/build-windows.yml)
